...
const authController_1 = __importDefault(require("../../controllers/shared/authController"));
...
router.post('/register', [
    ...
    (0, express_validator_1.body)('role').optional().isIn(['customer', 'vendor', 'rider']).withMessage('Invalid role')
